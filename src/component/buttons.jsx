  ...
  render(){
        return(
            ...
            <div className="row1">
              ...
              <button className="btn btn-action" onClick={this.handleclicks} value = "**">**</button>
              <button className="btn btn-action" onClick={this.handleclicks} value = "l10">L</button>
              <button className="btn btn-action" onClick={this.handleclicks} value = "sqr">sqr</button>
